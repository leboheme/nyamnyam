 ...
 */
public class AirSpikes extends AbstractAir {
    ...
    protected int getEatenScore() {
        return Constant.SCORE_AIR_SPIKES;
    }

    @Override
    protected void staffBeforeEaten(Avatar avatar) {
        super.staffBeforeEaten(avatar);
        getParent().addProjectile(EntityFactory.projectile(ProjectileType.SPIKE_BALL, this, avatar, true, false));
    }
